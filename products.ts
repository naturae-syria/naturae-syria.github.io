export const products = [
  ...
  },
  {
    ...
    category: "عناية بالشعر",
    description:
      "يحتوي على بروفيتامين B5، خلاصة الكيراتين، وزيوت طبيعية، يحمي الشعر من حرارة المجفف والمكواة حتى 230 درجة.",
  ...
  },
  {
    ...
    category: "عناية بالشعر",
    description:
      "يحتوي على البروتينات النباتية، الكيراتين النباتي، وزيت الأملا، يعيد بناء ألياف الشعر التالفة ويقوي الشعر من الداخل.",
  ...
  },
  {
    ...
    category: "عناية بالجسم",
    description:
      "تركيبة غنية بزيت طبيعي مستخلص من نباتات أمازونية مع عطر فريزيا الزهري، يمنح البشرة ترطيبًا عميقًا وعطراً ناعماً يدوم لساعات.",
    usage: "يُستخدم بعد الاستحمام على بشرة نظيفة وجافة.",
  ...
  },
  {
    ...
    category: "عناية بالجسم",
    description:
      "تركيبة خفيفة وغنية بمستخلص فاكهة البيتّانغا السوداء، يرطب البشرة بعمق ويمنحها رائحة فاكهية مميزة تدوم طويلاً.",
  ...
  },
  {
    ...
    category: "عناية بالشعر",
    description:
      "يحتوي على زيت باتاوا الطبيعي، البروتينات النباتية، وخلاصة نباتات الأمازون، يغذي الشعر الضعيف ويقويه من الجذور حتى الأطراف.",
  ...
  },
  {
    ...
    category: "عناية بالجسم",
    description:
      "يحتوي على ثلاث طبقات من الزيوت الطبيعية الغنية بمضادات الأكسدة المستخلصة من فاكهة الأساي، يرطب البشرة ويحميها من الجفاف.",
  ...
  },
  {
    ...
    category: "عناية بالجسم",
    description:
      "زيت عطري غني بزيوت اللوز الطبيعية ولمسة دافئة من القرفة، يمنح ترطيبًا فائقًا للبشرة ويتركها ناعمة ولامعة برائحة فاخرة تدوم طويلاً.",
  ...
  },
  {
    ...
    category: "عناية بالجسم",
    description:
      "تركيبة خفيفة غنية بزيت فاكهة الماراكويا من الأمازون، يرطب البشرة بعمق ويهدئ الحواس بعطر فاكهي ناعم مستوحى من الطبيعة.",
    usage: "يُستخدم يوميًا بعد الاستحمام على بشرة نظيفة وجافة.",
  ...
  },
  {
    ...
    category: "عطور للجسم",
    description:
      "عطر فاكهي خفيف ومنعش يحتوي على خلاصة فاكهة الماراكويا الأمازونية، يمنح شعوراً بالنقاء والهدوء طوال اليوم.",
  ...
  },
  {
    ...
    category: "عناية بالبشرة",
    description:
      "يحتوي على الريتينول النباتي، حمض الهيالورونيك، ومضادات الأكسدة، يعمل ليلاً على تجديد البشرة وتقليل التجاعيد.",
  ...
  },
  {
    ...
    category: "عناية بالبشرة",
    description:
      "يحتوي على حمض الهيالورونيك، مضادات أكسدة، خلاصة الجنكة بيلوبا، وواقي شمسي SPF30، يحارب علامات التقدم في السن ويرطب البشرة.",
  ...
  },
  {
    ...
    category: "عناية بالبشرة",
    description:
      "يحتوي على حمض الساليسيليك، الزنك، وخلاصة الأرواق الطبيعية، يساعد على تقليل اللمعان وتنقية المسام وتنظيم إفراز الدهون.",
  ...
  },
  {
    ...
    category: "عطور للجسم",
    description:
      "رذاذ جسم منعش برائحة دافئة تجمع بين التمر الحلو ولمسة خفيفة من القرفة، يمنح إحساسًا بالعطر الفاخر طوال اليوم.",
