export const products = [
  ...
  },
  {
    ...
    category: "عناية بالشعر",
    description:
      "يحتوي على بروفيتامين B5، خلاصة الكيراتين، وزيوط طبيعية، يحمي الشعر من حرارة المجفف والمكواة حتى 230 درجة.",
  ...
  {
    name: "بلسم مرطب من إكوس",
    brand: "Natura",
    line: "EKOS",
    category: "عناية بالجسم",
    description: "تركيبة غنية بزيوت الأمازون الطبيعية، ترطب البشرة بعمق وتمنحها نعومة فائقة ورائحة طبيعية منعشة.",
    usage: "يُستخدم بعد الاستحمام على بشرة نظيفة ورطبة.",
    explanation: "يعزز مرونة البشرة ويحميها من الجفاف مع إحساس بالانتعاش يدوم طوال اليوم.",
    image: "/placeholder.svg?height=300&width=300",
    name_pt: "EKOS BALSAMO HIDRATANTE CORPORAL",
    price: 65.0,
  },
]
